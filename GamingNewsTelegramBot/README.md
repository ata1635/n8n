...
An intelligent n8n workflow that connects to a Telegram bot to fetch, summarize, and deliver the latest **gaming news** — powered by AI.  
...
- 🌐 **Web search** – finds relevant articles about your topic  
- 🧠 **AI summarization** – condenses each article into short summaries  
- 🚫 **Ad filtering** – automatically removes sponsored or promotional content  
...
3. The workflow fetches articles from predefined gaming news URLs (PC Gamer, GameStar, ...)
...
## 🧩 Workflow Structure
```plaintext
Telegram Trigger → Web Search (HTTP) → AI Filter & Summarize → Telegram Send
